...
//@Aspect
@Slf4j
public class PaymentActivityLogger {

//    @Pointcut("execution(* com.upinmcSE.coffeeshop.controller.PaymentController.vnPayCallbackHandler(..))")
//    public void vnPayCallbackHandlerMethod(){}
//
//    // Advice to execute after the create method returns successfully
//    @AfterReturning(pointcut = "vnPayCallbackHandlerMethod()", returning = "result")
